...
{
	public class LeafAncestorReport : IBaseReport
	{
		...
		private void OutputReport(string rootIndividialId, string outputPath)
		{
			using (StreamWriter writer = new StreamWriter(outputPath))
			{
				...
				writer.WriteLine(string.Format("Leaf Ancestor Report for {0}", ancestors[rootIndividialId].SummaryName));
